...
Logging in as a non-owner (ex. Username: Issac, password: password) will allow you to browse books, link an address, or logout.
Owners may also access these options.
